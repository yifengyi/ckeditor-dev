...
* [#1113](https://github.com/ckeditor/ckeditor-dev/issues/1113): [Firefox] Fixed: Nested contenteditable elements path not updated on focus with [divarea](https://ckeditor.com/cke4/addon/divarea) plugin.
